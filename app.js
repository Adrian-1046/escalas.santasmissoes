...
const ministrantes_dm = require('./index/funcoesDeBanco/ministrantes_dm')
const ministrantes_dn = require('./index/funcoesDeBanco/ministrantes_dn')
const ministrantes_t = require('./index/funcoesDeBanco/ministrantes_t')
const ministrantes_q = require('./index/funcoesDeBanco/ministrantes_q')
const musicas_dm = require('./index/funcoesDeBanco/musicas-dm')
const musicas_dn = require('./index/funcoesDeBanco/musicas-dn')
const musicas_t = require('./index/funcoesDeBanco/musicas-t')
const musicas_q = require('./index/funcoesDeBanco/musicas-q')
...
app.get(  '/inicio/pregadores/:tela',
  verificaAutenticacao,
...
app.get(  '/inicio/recepcionistas/:tela',
  verificaAutenticacao,
...
app.get(  '/inicio/escalas/:tela/:dia',
  verificaAutenticacao,
...
app.get('/inicio/musicas/:tela/', verificaAutenticacao, async (req, res) => {
  ...
  try {
    ...
    async function consultar_dm(){
      result = await musicas_dm.findAll({
        attributes: [
          `DATA`,
          `MINISTRO`,
          `MUSICA`,
    ...
    async function consultar_dn(){
      result = await musicas_dn.findAll({
        attributes: [
          `DATA`,
          `MINISTRO`,
          `MUSICA`,
    ...
    async function consultar_t(){
      result = await musicas_t.findAll({
        attributes: [
          `DATA`,
          `MINISTRO`,
          `MUSICA`,
    ...
    async function consultar_q(){
      result = await musicas_q.findAll({
        attributes: [
          `DATA`,
          `MINISTRO`,
          `MUSICA`,
...
app.get(  '/inicio/pregadores-ADM/:tela',
  verificaAutorizacao,
  async (req, res) => {
    const tela = req.params.tela
...
app.get(  '/inicio/recepcionistas-ADM/:tela',
  verificaAutorizacao,
  async (req, res) => {
    const tela = req.params.tela
...
app.post(  '/atualizar-escalas-ADM/:tela',
  verificaAutorizacao,
  async (req, res) => {
    const tela = req.params.tela
...
app.post('/atualizar-ministrantes-ADM/:tela',
verificaAutorizacao,
async (req, res) => {
  const tela = req.params.tela
  const UmIgualUm = '1'
  ...
  switch (tela) {
    case 'DomingoManha':
      atualizar_ministro_dm(req, res)
      break;
    case 'DomingoNoite':
      atualizar_ministro_dn(req, res)
      break;
    case 'Terca':
      atualizar_ministro_t(req, res)
      break;
    case 'Quarta':
      atualizar_ministro_q(req, res)
      break;
    default:
      break;
  }

  async function atualizar_ministro_dm(req, res){
    try {
      const {
        ministroS1,
        dataS1,
      ...
      await ministrantes_dm.update(
        {
          'MINISTRANTE_S1': ministroS1,
          'DATA_S1': dataS1,
          'MINISTRANTE_S2': ministroS2,
          'DATA_S2': dataS2,
          'MINISTRANTE_S3': ministroS3,
          'DATA_S3': dataS3,
          'MINISTRANTE_S4': ministroS4,
          'DATA_S4': dataS4,
          'MINISTRANTE_S5': ministroS5,
          'DATA_S5': dataS5,
        },
        { where: {} } 
      )
...
async function atualizar_ministro_dn(req, res){
  try {
    const {
      ministroS1,
      dataS1,
...
async function atualizar_ministro_t(req, res){
  try {
    const {
      ministroS1,
      dataS1,
...
async function atualizar_ministro_q(req, res){
  try {
    const {
      ministroS1,
      dataS1,
...
app.get('/inicio/escalas-ADM/:tela', verificaAutorizacao, async (req, res) => {
  ...
  try {
    ...
    const dados = `${result.S1_DATA};${result.S1_MINISTRO};${result.S1_VIOLAO};${result.S1_BAIXO};${result.S1_TECLADO};${result.S1_BATERIA};${result.S1_GUITARRA};${result.S1_BACK_1};${result.S1_BACK_2};${result.S1_BACK_3};${result.S1_MIDIA};${result.S1_SOM};${result.S2_DATA};${result.S2_MINISTRO};${result.S2_VIOLAO};${result.S2_BAIXO};${result.S2_TECLADO};${result.S2_BATERIA};${result.S2_GUITARRA};${result.S2_BACK_1};${result.S2_BACK_2};${result.S2_BACK_3};${result.S2_MIDIA};${result.S2_SOM};${result.S3_DATA};${result.S3_MINISTRO};${result.S3_VIOLAO};${result.S3_BAIXO};${result.S3_TECLADO};${result.S3_BATERIA};${result.S3_GUITARRA};${result.S3_BACK_1};${result.S3_BACK_2};${result.S3_BACK_3};${result.S3_MIDIA};${result.S3_SOM};${result.S4_DATA};${result.S4_MINISTRO};${result.S4_VIOLAO};${result.S4_BAIXO};${result.S4_TECLADO};${result.S4_BATERIA};${result.S4_GUITARRA};${result.S4_BACK_1};${result.S4_BACK_2};${result.S4_BACK_3};${result.S4_MIDIA};${result.S4_SOM};${result.S5_DATA};${result.S5_MINISTRO};${result.S5_VIOLAO};${result.S5_BAIXO};${result.S5_TECLADO};${result.S5_BATERIA};${result.S5_GUITARRA};${result.S5_BACK_1};${result.S5_BACK_2};${result.S5_BACK_3};${result.S5_MIDIA};${result.S5_SOM}`
...
app.post(  '/atualizar-recepcionistas-ADM/:dia',
  verificaAutorizacao,
  async (req, res) => {
    try {
      const {
...
app.post(  '/atualizar-pregadores-ADM/:dia',
  verificaAutorizacao,
  async (req, res) => {
    try {
      const {
...
app.post(  '/atualizar-recepcionistas/:dia',
  verificaAutorizacao,
  async (req, res) => {
    try {
      const {
...
app.post(  '/atualizar-pregadores/:dia',
  verificaAutorizacao,
  async (req, res) => {
    try {
      const {
...
app.post('/atualizar-musicas/:tela', verificaAutorizacao, async (req, res) => {
  ...
  try {
    ...
    switch (tela) {
      ...
      async function inserir_musicas_dm(){
        try {
        await musicas_dm.create({
          [`DATA`]: DATA,
          [`MINISTRO`]: MINISTRO,
          [`MUSICA`]: MUSICA,
          [`LINK`]: LINK,
      ...
      async function inserir_musicas_dn(){
        try {
        await musicas_dn.create({
          [`DATA`]: DATA,
          [`MINISTRO`]: MINISTRO,
          [`MUSICA`]: MUSICA,
          [`LINK`]: LINK,
      ...
      async function inserir_musicas_t(){
        try {
        await musicas_t.create({
          [`DATA`]: DATA,
          [`MINISTRO`]: MINISTRO,
          [`MUSICA`]: MUSICA,
          [`LINK`]: LINK,
      ...
      async function inserir_musicas_q(){
        try {
        await musicas_q.create({
          [`DATA`]: DATA,
          [`MINISTRO`]: MINISTRO,
          [`MUSICA`]: MUSICA,
          [`LINK`]: LINK,
...
app.listen( process.env.MSQLPORT ?? porta, function () {
  console.log(`Servidor rodando em http://localhost:` + process.env.MSQLPORT ?? porta)
})
